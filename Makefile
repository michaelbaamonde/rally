...
unit-tests: check-venv python-caches-clean tox-env-clean
	. $(VENV_ACTIVATE_FILE); tox -e py38-unit
	. $(VENV_ACTIVATE_FILE); tox -e py310-unit

integration-tests: check-venv python-caches-clean tox-env-clean
	. $(VENV_ACTIVATE_FILE); tox -e py38-it
	. $(VENV_ACTIVATE_FILE); tox -e py310-it

it: check-venv python-caches-clean tox-env-clean unit-tests integration-tests
